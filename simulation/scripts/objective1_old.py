...
def main():
    ...
    waypoint_3 = np.array([[-0.38850759 , 0.92061979 , 0.03900185 , 0.223871],
                             [ 0.06889716, -0.01318528,  0.99753671, 0.188884],
                             [0.91886622,  0.39023775, -0.05830539, 0.370449], 
                             [0,0,0,1]])
    ...
    waypoint_4 = np.array([[ 0.22548577 ,-0.05397673 , 0.97274996, 0.288833],
    ...
    waypoint_5 = np.array([[ 0.23103422 ,-0.03434747 , 0.97233928 ,0.29084],
    ...
    waypoint_6 = np.array([[ 0.23476259, -0.04472845 , 0.97102199, 0.294083 ],
    ...
    waypoint_7 = np.array([[ 0.23476259, -0.04472845  ,0.97102199, 0.24787],
    ...
    waypoint_8 = np.array([[ 0.2401747 , -0.02943428 , 0.97028199, 0.289321],
    ...
    waypoint_9 = np.array([[ 0.14108441,  0.98926439 , 0.0380909 , 0.277796 ],
    ...
    waypoint_10 = np.array([[ 0.14108441 , 0.98926439 , 0.0380909 , 0.270651 ],
    ...
    waypoint_11 = np.array([[ 0.12741546 ,-0.04724393, -0.99072356, -0.273816],
    ...
    waypoint_12 = np.array([[ 0.14126115, -0.98988924,  0.01285855,0.282459],
    ...
    waypoint_13 = np.array([[ 0.82095203, -0.34775911,  0.45288926, 0.31375],
    ...
    waypoint_14 = np.array([[ 0.02055522, -0.99214174, -0.12335268, 0.14315],
    ...
    waypoint_15 = np.array([[ 0.25355372,  0.00806933,  0.9672928, 0.17022 ],
                            [-0.32569184, -0.94086943,  0.09322028, -0.20891],
                            [ 0.91084867, -0.338674,   -0.23592519, 0.21088],
                            [0, 0, 0, 1]])

    aruco = np.matmul(waypoint_15, matrix)

    list[14].aruco_id = A_id
    list[14].position_x = aruco[0,3]
    list[14].position_y = aruco[1,3]
    list[14].position_z = aruco[2,3]
    
    print (list[14].aruco_id)
    print (list[14].position_x, list[14].position_y, list[14].position_z)
