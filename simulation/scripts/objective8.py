...
def main():
    ...
    joint_target[0] = -1.309
    joint_target[1] = -1.46608
    joint_target[2] = 1.20428
    joint_target[3] = 0.279253
    joint_target[4] = 1.85005
    ...
    wpose.position.x += -0.0011842
    waypoints.append(deepcopy(wpose))
    wpose.position.y += 0.000311
    waypoints.append(deepcopy(wpose))
    wpose.position.z += 0.3083165
    waypoints.append(deepcopy(wpose))
...
if __name__=="__main__":
    rospy.init_node("objective8", anonymous=True)
